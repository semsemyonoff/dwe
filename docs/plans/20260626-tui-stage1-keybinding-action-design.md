...
- [ ] verify every Overview deliverable exists and is exercised by tests (Aliases
...
- [ ] verify **no new importers** of `tui` and `core/docs` untouched. Expected
...
- [ ] run `make build` so the embedded copy of `packages.md` regenerates (the
