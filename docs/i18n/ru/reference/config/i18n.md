> Translated from: reference/config/i18n.md @ b73466fb4d25
...
devbox docs show config/services/fields --lang ru
...
DEVBOX_LANGUAGE=ru devbox commands list

# Закрепить на сессию shell
export DEVBOX_LANGUAGE=de
devbox commands list  # → немецкий

# Явный --lang всё равно побеждает DEVBOX_LANGUAGE
DEVBOX_LANGUAGE=de devbox docs show config/services/fields --lang ru
...
1. **Флаг `--lang`** (только подкоманды docs; например, `devbox docs show config/services/fields --lang ru`)
...
- `devbox commands list` — отображает описания команд в активной локали
