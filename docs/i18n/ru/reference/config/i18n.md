> Translated from: reference/config/i18n.md @ 03a0f6362ae5
...
2. **Длинный markdown** (новое): markdown-файлы под `docs/i18n/<lang>/reference/...`, `docs/i18n/<lang>/guides/...` и `docs/i18n/<lang>/internals/...`. Переводы встроенной справочной документации, ориентированных на задачи руководств и архитектурных заметок.
