> Translated from: reference/config/validate.md @ 6a4facf4c65a
...
**5. Корпоративный VPN доступен (tcp_reachable):**
...
**6. Скрипт проверки зависимостей проекта (type: command):**
...
**7. Только compose-плагин v2 (executable_in_path):**
