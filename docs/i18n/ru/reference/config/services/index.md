> Translated from: reference/config/services/index.md @ 376217eef53f
...
- Семантика типов разделяет порядок эмиссии файлов `docker compose` на `tool → infra → app → compose_after`.
