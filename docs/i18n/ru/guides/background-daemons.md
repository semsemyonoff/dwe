> Translated from: guides/background-daemons.md @ b2dcd1937aba
...
Полная схема — в [`../reference/config/commands/types.md#тип-daemon`](../reference/config/commands/types.md#тип-daemon); эта страница описывает приёмы, к которым вы будете обращаться при настройке.
...
- [`../reference/config/commands/types.md#тип-daemon`](../reference/config/commands/types.md#тип-daemon) — полная схема, правила валидации, метки, реализация виртуальных команд.
