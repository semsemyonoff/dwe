> Translated from: README.md @ e32085632b86
...
- [Хост-бридж](../../reference/bridge.md) монтирует крошечный shim `dwe` в dev-контейнеры, поэтому git-хуки и проектные команды работают одинаково на хосте и в терминале devcontainer.
