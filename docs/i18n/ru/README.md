> Translated from: README.md @ 3d302c612b7e
...
Devbox находится в активной pre-release разработке. Имена полей, команды, раскладка конфигурации и поверхности — всё меняется без слоёв обратной совместимости. Релизных версий нет, и нет сторонних проектов, зависящих от схемы. Воспринимайте живые проекты в монорепозитории как фикстуры, а не как ограничения совместимости.
...
Лицензионные условия пока не финализированы для этого pre-release. Файл `LICENSE` будет добавлен в корень репозитория перед первым тегированным релизом.
