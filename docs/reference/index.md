...
User-facing reference for the DWE CLI: project configuration, render packs, the docs subsystem, the template engine, and the auto-generated CLI command tree.
...
- [CLI reference (`cli/`)](cli/index.md) — auto-generated command tree (regenerated by `dwe docs generate`)
