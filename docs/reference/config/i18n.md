...
1. **`--lang` flag** (docs subcommands only; e.g., `devbox docs show config/services/fields --lang ru`)
...
- `devbox commands list` — displays command descriptions in the active locale
