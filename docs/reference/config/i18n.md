...
2. **Long-form markdown** (new): Markdown files under `docs/i18n/<lang>/reference/...`, `docs/i18n/<lang>/guides/...`, and `docs/i18n/<lang>/internals/...`. Translations of the built-in reference documentation, task-oriented guides, and architecture notes.
