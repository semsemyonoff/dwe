...
func Builtins() map[string]spec.Entry {
	return map[string]spec.Entry{
		...
		"service_configs_render":       {Impl: ConfigsRender{}, Kind: spec.KindAction},
		"service_configs_render_check": {Impl: ConfigsRenderCheck{}, Kind: spec.KindAction},
		"service_generated_harvest":    {Impl: GeneratedHarvest{}, Kind: spec.KindAction},
