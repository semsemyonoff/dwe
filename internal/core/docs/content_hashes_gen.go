...
var ContentHashes = map[string]string{
	...
	"reference/concepts/getting-started.md":    "5f8a88577bb6",
	...
	"reference/config/tests.md":                "ae9d9e6e8a4c",
