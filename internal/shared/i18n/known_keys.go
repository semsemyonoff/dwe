...
var KnownUIKeys = []string{
	...
	"tui.help.action.reload",
	"tui.help.action.cmd.skip-confirm",
	"tui.help.action.cmd.force-form",
	// Docs browser custom sections and actions (registered by docstui plugin).
	"tui.help.section.filter",
	"tui.help.section.diagrams",
	"tui.help.section.locales",
	"tui.help.action.diagram.prev",
	"tui.help.action.diagram.next",
	"tui.help.action.diagram.open",
	"tui.help.action.diagram.copy",
	"tui.help.action.locale.cycle",
	...
	"tui.help.action.section.next",
	"tui.help.action.section.prev",
