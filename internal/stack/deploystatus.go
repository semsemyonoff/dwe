...
func BuildDeployStatusView(state *journal.ProjectState, cfg *config.DevboxConfig, svcDeploys map[string]*config.DeployConfig, tracked []string) *statusview.DeployStatusView {
